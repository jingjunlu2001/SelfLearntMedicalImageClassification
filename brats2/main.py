...
from models import Unet_with_slice, Unet_with_inception, Inception, Unet, UnetRes
...
model = network.ResnetBuilder.build_resnet_34((4, 240, 240), 2)
learning_rate = 0.001
epochs = 5000
decay_rate = learning_rate / epochs
model.compile(optimizer=Adam(lr=learning_rate, decay = decay_rate), loss='sparse_categorical_crossentropy', metrics=['accuracy'])
model.summary()
...
model.fit(x=x_to, y=y_to, batch_size=32, epochs=5)
